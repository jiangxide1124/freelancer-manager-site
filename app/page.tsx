...
const FAQ_CATEGORIES: {
  ...
  },
  {
    ...
    items: [
      {
        q: "시리얼 키는 어떻게 받나요?",
        a: "사이트의 \"🎁 베타 무료로 시작하기\" 버튼을 클릭해서 이메일을 입력하시면 시리얼 키가 즉시 화면에 표시됩니다. 표시된 키를 복사해서 메모장이나 안전한 곳에 꼭 보관해주세요. (이메일 발송은 정식 출시 후 본인 도메인 등록 시 활성화 예정)",
      },
      {
        q: "시리얼 키를 잃어버렸어요. 다시 받을 수 있나요?",
        a: "네, 가능합니다. 페이지 하단 푸터 또는 요금제 섹션의 \"🔍 시리얼 키를 잊으셨나요?\" 링크를 클릭하시고 신청 시 사용한 이메일을 입력하시면, 발급된 키가 화면에 바로 표시됩니다. 만약 이메일이 기억 안 나거나 조회가 안 되면 카카오톡 오픈채팅으로 문의해주세요 — 본인 확인 후 키를 알려드립니다.",
      },
      {
    ...
    <main className="flex-1">
        ...
        <div className="max-w-4xl mx-auto px-6 py-12">
          ...
          >
            ...
            <p className="text-center mt-2.5 text-[11px] text-slate-500">
              이메일 입력 → 시리얼 키 화면 즉시 표시 (꼭 복사해서 보관)
            </p>
      ...
      >
        <div className="max-w-4xl mx-auto px-6 py-20 text-center">
          ...
          <p className="mt-6 text-xs text-slate-500">
            ※ 현재 베타 운영 중. 다운로드 후 시리얼 키 입력 화면이 나오면 메인 화면 상단{' '}
            <strong className="text-emerald-400">🎁 베타 무료로 시작하기</strong> 버튼으로 키를 발급받거나, 문의가 있으면{' '}
            <a
              href={KAKAO_OPEN_CHAT}
              target="_blank"
              rel="noopener noreferrer"
